...
**You do not need** a model API key for the Northflank / dedicated router
endpoint. The script leaves the lane builder key empty when using `custom/*`.
...
## Run against the Kimi / Northflank-style endpoint
